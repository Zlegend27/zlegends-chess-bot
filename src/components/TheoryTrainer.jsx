        ...
        <div className="box lessonBox">
          ...
          {result ? (
            ...
            <>
              ...
              <p className="lessonHint">Undo to stay in the lines, or keep playing — the engine has White now.</p>
            ...
            <>
              ...
              {botThinking && <p className="lessonHint">Bot is moving…</p>}
            </>
          ) : (
            <>
              ...
              {botThinking && <p className="lessonHint">Bot is thinking…</p>}
            </>
          )}
